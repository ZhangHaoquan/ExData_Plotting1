...
par(mfrow=c(2,2))
#- Top Left -#
with(sub_hse_pwr_con, plot(DateTime,Global_active_power,type='l',xlab="",ylab='Global Active Power'))

#- Top Right -#
with(sub_hse_pwr_con, plot(DateTime,Voltage,type='l',xlab="datetime",ylab='Voltage'))
...
legend('topright', legend=paste("Sub_metering_",1:3,sep=""), col=c("Black","Red","Blue"), lty=1, bty='n')

#- Bottom Right -#
with(sub_hse_pwr_con, plot(DateTime,Global_reactive_power,type='l',xlab="datetime",ylab='Global_reactive_power'))
dev.off()
